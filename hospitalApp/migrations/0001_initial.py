# Generated by Django 4.2.11 on 2024-07-18 16:57
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('appoinmentDate', models.DateField(auto_now=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('profile_pic', models.ImageField(blank=True, null=True, upload_to='profile_pic/DoctorProfileP,ic/')),
                ('address', models.CharField(max_length=40)),
                ('mobile', models.CharField(max_length=20, null=True)),
